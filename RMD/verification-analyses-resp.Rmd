...
go.clique.enrichments = Map( function ( targets )
  filterFDR( hyperGeometricEnrichmentRanking( targets, go.map ), 0.05 ), cliques )
...
go.attachment.enrichments = Map( function ( targets )
  filterFDR( hyperGeometricEnrichmentRanking( targets, go.map ), 0.05 ), attachments.by.action )
